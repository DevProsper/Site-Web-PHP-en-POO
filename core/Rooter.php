<?php 
/**
* Gestion des routes, creation des urls
**/
class Rooter{
	/**
	* Permet de sauvegarder les routes
	**/
	static $routes = array();
	...
	**/
	...
	/**
	* Connect l'url passé par l'utilisateur
	*@param $redir   
	*@param $url
	**/
